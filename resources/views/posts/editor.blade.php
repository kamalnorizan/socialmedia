...
@section('head')
    ...
    <link rel="stylesheet" type="text/css"
        href="https://cdn.datatables.net/datetime/1.5.4/css/dataTables.dateTime.min.css" />
    <link rel="stylesheet" type="text/css"
        href="https://editor.datatables.net/extensions/Editor/css/editor.dataTables.css" />
@endsection
...
@section('script')
    ...
    <script type="text/javascript" src="https://cdn.datatables.net/keytable/2.12.1/js/keyTable.dataTables.js"></script>
    <script type="text/javascript" src="https://cdn.datatables.net/datetime/1.5.4/js/dataTables.dateTime.min.js"></script>
    <script type="text/javascript" src="{{ asset('Editor-2.3.2/js/dataTables.editor.js') }}"></script>
    <script type="text/javascript" src="{{ asset('Editor-2.3.2/js/editor.bootstrap4.js') }}"></script>

    <script>
        const editor = new DataTable.Editor({
            ajax: "{{ route('posts.store') }}",
            table: "#posttbl",
            fields: [{
                    label: 'Author',
                    name: 'author'
        ...
        posttbl.on('click', 'tbody td:not(:first-child)', function(e) {
            editor.inline(this);
        });
    </script>
@endsection
